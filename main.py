...
optimizer = torch.optim.Adam(model.parameters(), lr=0.0005, weight_decay=0.0025)
...
for epoch in range(1, n_epochs+1):
    ...
    for data in train_loader:
        ...
        if it%1000 == 0:
            #print('Saving model')
            torch.save(model.state_dict(), "/content/drive/My Drive/IML/task4/anet_reg0025.pt")
    ...
    print('Saving model')
    torch.save(model.state_dict(), "/content/drive/My Drive/IML/task4/anet_reg0025_epoch{}.pt".format(ep))
    ep = ep + 1
